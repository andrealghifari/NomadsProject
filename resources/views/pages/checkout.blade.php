@extends('layouts.checkoutlayout')
@section('title', 'Checkout Page')

@push('addons-style')
<link rel="stylesheet" href="{{url('frontend/styles/checkout.css')}}" />
<link href="https://fonts.googleapis.com/css?family=Playfair+Display:400,700&display=swap" rel="stylesheet"/>
<link rel="stylesheet" href="{{url('frontend/libraries/jquery/gijgo/css/gijgo.min.css')}}" />
@endpush
                ...
                <table class="table table-responsive-sm text-center">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td class="align-middle">Andre Alghfari</td>
                      <td class="align-middle">IDN</td>
                      <td class="align-middle">N/A</td>
                      <td class="align-middle">Not Active</td>
                      <td class="align-middle">
                        <a href="#">
                          <img src="frontend/images/exit.png" alt="" />
                        </a>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td class="align-middle">Nazli Ileri</td>
                      <td class="align-middle">Turk</td>
            ...
            <div class="card card-details card-right">
              ...
              <div class="bank">
                <div class="bank-item pb-3">
                  <img
                    src="frontend/images/checkout/credit-card.png"
                    alt=""
                    class="bank-image"
                  />
...
@push('addons-script')
{{-- Script addons --}}
<script src="{{url('frontend/libraries/jquery/gijgo/js/gijgo.min.js')}}"></script>
<script>
    $(document).ready(function() {
        $('.datepicker').datepicker({
          uiLibrary: 'bootstrap4',
          icons: {
            rightIcon: '<img src="{{url('frontend/images/checkout/ic_doe.png')}}" alt=""/>'
          }
        });
      });
</script>
